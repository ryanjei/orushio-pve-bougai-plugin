...
public final class YamlGameLaunchSettingsRepository implements GameLaunchSettingsRepository{
    ...
    public GameLaunchSettings load(String mapId){return store(mapId).read().map(v->new GameLaunchSettings(optionalInt(v,"timeLimitMinutes"),optionalInt(v,"requiredNormalCores"),optionalDouble(v,"enemyMultiplier"))).orElseGet(GameLaunchSettings::defaults);}
