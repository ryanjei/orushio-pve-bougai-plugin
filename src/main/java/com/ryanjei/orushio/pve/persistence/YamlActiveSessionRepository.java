...
public final class YamlActiveSessionRepository implements ActiveSessionRepository {
    ...
    private static void requireSchemaVersionOne(Map<String,String> values){if(!"1".equals(values.get("schemaVersion")))throw new RepositoryException("active-sessionのschemaVersionが未対応です。");}
}
