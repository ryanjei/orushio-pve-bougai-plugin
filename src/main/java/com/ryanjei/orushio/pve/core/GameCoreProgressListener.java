...
public final class GameCoreProgressListener implements CoreProgressListener{
 ...
 public void finalCoreDestroyed(UUID sessionId){GameApplicationService game=Objects.requireNonNull(games.get(),"Game lifecycleが初期化されていません。");recoveryDispatcher.accept(()->{game.completeGame(sessionId);game.recoverClearGame(sessionId);});}
}
