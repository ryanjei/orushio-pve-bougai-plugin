...
public enum SetupMarkerType {
    ...
    FARM_RESPAWN("ファーム復帰地点",Category.MOVEMENT),GAME_START("ゲーム開始地点",Category.MOVEMENT),FINAL_AREA_ENTRY("最終エリア入口",Category.MOVEMENT),FINAL_AREA_DESTINATION("最終エリア転送先",Category.MOVEMENT),CHECKPOINT("チェックポイント",Category.MOVEMENT),FINAL_GATE("最終ゲート構成ブロック",Category.GATE);
