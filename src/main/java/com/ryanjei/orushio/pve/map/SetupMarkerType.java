...
public enum SetupMarkerType {
    ...
    INITIAL_RESPAWN("初期リスポーン地点",Category.MOVEMENT),WARP("ワープブロック",Category.MOVEMENT),SAVE_POINT("セーブポイントブロック",Category.MOVEMENT),FINAL_GATE("最終ゲート構成ブロック",Category.GATE);
