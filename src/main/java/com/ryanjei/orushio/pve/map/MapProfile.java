...
public record MapProfile(MapProfileId mapId, String displayName, boolean enabled, String templateDirectory,
    ...
    public static final Map<SetupMarkerType,Integer> REQUIRED_MARKERS=Map.of(
        SetupMarkerType.INITIAL_RESPAWN,1,SetupMarkerType.NORMAL_CORE,3,
        SetupMarkerType.FINAL_CORE,1,SetupMarkerType.FINAL_GATE,1,SetupMarkerType.WARP,1);
    ...
    public MapProfile {
        ...
        points=immutable(points);areas=immutable(areas);Objects.requireNonNull(createdAt);spawnMarkers=List.copyOf(spawnMarkers==null?List.of():spawnMarkers);setupMarkers=List.copyOf(setupMarkers==null?List.of():setupMarkers);
